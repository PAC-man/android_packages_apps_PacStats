...
public class ReportingServiceManager extends BroadcastReceiver {
    ...
    protected static void setAlarm (Context ctx) {
        ...
        prefs.edit().putBoolean(PACStats.PAC_ALARM_SET, false).apply();
        boolean optedIn = prefs.getBoolean(PACStats.PAC_OPT_IN, true);
        boolean firstBoot = prefs.getBoolean(PACStats.PAC_FIRST_BOOT, true);
        ...
        prefs.edit().putBoolean(PACStats.PAC_ALARM_SET, true).apply();
    }
    ...
    public static void launchService (Context ctx) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            boolean firstBoot = prefs.getBoolean(PACStats.PAC_FIRST_BOOT, true);
            boolean optedIn = prefs.getBoolean(PACStats.PAC_OPT_IN, true);
            boolean alarmSet = prefs.getBoolean(PACStats.PAC_ALARM_SET, false);
            if (alarmSet) {
                return;
            }
