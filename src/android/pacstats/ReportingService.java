...
public class ReportingService extends Service {
	...
	private void report() {
		...
		if (PACStatsUrl == null || PACStatsUrl.isEmpty()) {
			Log.e(Utilities.TAG, "This ROM is not configured for PAC Stats.");
			return;
		}
		...
		try {
            ...
            getSharedPreferences(Utilities.SETTINGS_PREF_NAME, 0).edit().putLong(PACStats.PAC_LAST_CHECKED,
	...
	private void promptUser() {
		...
		Intent nI = new Intent(this, PACStats.class);
